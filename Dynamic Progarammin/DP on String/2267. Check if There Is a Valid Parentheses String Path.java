...
grid[i][j] is either '(' or ')'.
  ...
  class Solution {
    ...
    public boolean hasValidPath(char[][] grid) {
        ...
        return findValidPath(grid , 0 , 0, 0);
    }
    public boolean findValidPath(char[][]grid , int i , int j, int open){
        ...
        boolean down = findValidPath(grid , i+1 , j, open);
        boolean right = findValidPath(grid , i , j+1 , open);
